    ...
    <div class="p-1.5 min-w-full inline-block align-middle">
        ...
        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
            ...
            <div class="inline-flex gap-x-2">
                ...
                <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange-700 focus:outline-hidden focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none" href="">
        ...
        <!-- Table -->
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700" id="search-table" >
            ...
            <tr class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                ...
                <button type="button" class="block text-start" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-attendance-modal-{{ $attendance->id }}" data-hs-overlay="#hs-attendance-modal-{{ $attendance->id }}">
                    ...
                    <div class="flex items-center gap-x-3">
                        ...
                        <span class="text-sm font-medium text-orange-800 dark:text-orange-400">
                            {{ substr($attendance->student->user->name  ?? 'N/A', 0, 1) }}
                        </span>
                        </div>
                        <div class="grow">
                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $attendance->student->user->name  ?? 'N/A' }}</span>
                        <span class="block text-xs text-gray-600 dark:text-neutral-400">{{ $attendance->student->nis ?? 'N/A' }}</span>
                        </div>
                    </div>
                    </span>
                </button>
                ...
                <button type="button" class="block text-start" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-attendance-modal-{{ $attendance->id }}" data-hs-overlay="#hs-attendance-modal-{{ $attendance->id }}">
                    ...
                    @if($attendance->approved_by)
                        ...
                        by {{ $attendance->company->user->name ?? 'N/A' }}
                        </span>
                    @endif
                    </span>
                </button>
                ...
                <button type="button" class="block text-start" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-attendance-modal-{{ $attendance->id }}" data-hs-overlay="#hs-attendance-modal-{{ $attendance->id }}">
                    <span class="block px-6 py-2">
                    <span class="text-sm text-gray-600 dark:text-neutral-400">
                        {{ $attendance->company->supervisor_name?? 'N/A' }}
                    </span>
                    </span>
                </button>
                </td>
